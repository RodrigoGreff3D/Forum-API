package br.com.forumapi.forum.config.security;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(autenticacaoService).passwordEncoder(new BCryptPasswordEncoder());// logica de
																									// autenticacao
	}
	...
	// Config de recursos estáticos(JavaScrip, css, imagens etc)
	@Override
